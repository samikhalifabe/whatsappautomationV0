...
import { InfoIcon, AlertCircle, CheckCircle2, RefreshCw } from "lucide-react";
        ...
        <div className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Dernière mise à jour: {new Date(logs.timestamp).toLocaleString()}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center space-x-2">
                  <div className={`w-3 h-3 rounded-full ${logs.whatsapp.isRunning ? 'bg-green-500' : 'bg-red-500'}`}></div>
                  <span>Serveur WhatsApp: {logs.whatsapp.isRunning ? "En cours d'exécution" : "Arrêté"}</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className={`w-3 h-3 rounded-full ${logs.nextjs.isRunning ? 'bg-green-500' : 'bg-red-500'}`}></div>
          ...
          <Tabs defaultValue="whatsapp">
            ...
            <TabsContent value="nextjs">
              <Card>
                ...
                <CardFooter>
                  <p className="text-sm text-gray-500">
                    Pour voir les logs complets de l'application Next.js, consultez le terminal où l'application est exécutée.
                  </p>
                </CardFooter>
              </Card>
            </TabsContent>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    <li>Exécutez le serveur avec <code className="bg-gray-100 p-1 rounded">node server.js</code> pour voir les logs en temps réel.</li>
                    <li>Utilisez <code className="bg-gray-100 p-1 rounded">console.log()</code> pour afficher des informations de débogage.</li>
                    <li>Pour un débogage plus avancé, exécutez <code className="bg-gray-100 p-1 rounded">node --inspect server.js</code> et utilisez Chrome DevTools.</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    <li>Exécutez l'application avec <code className="bg-gray-100 p-1 rounded">npm run dev</code> pour voir les logs en temps réel.</li>
                    <li>Utilisez les outils de développement du navigateur pour déboguer le frontend.</li>
                    <li>Pour déboguer les API routes, ajoutez des <code className="bg-gray-100 p-1 rounded">console.log()</code> dans vos fichiers route.ts.</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    <li>Configurez le fichier launch.json pour déboguer le serveur WhatsApp et l'application Next.js.</li>
                    <li>Utilisez des points d'arrêt pour suspendre l'exécution et inspecter les variables.</li>
                    <li>Consultez la <a href="https://code.visualstudio.com/docs/nodejs/nodejs-debugging" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">documentation VS Code</a> pour plus d'informations.</li>
                  </ul>
                </div>
              </div>
            </CardContent>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center py-8">
              <p className="text-gray-500">Aucune donnée disponible. Cliquez sur "Rafraîchir" pour récupérer les logs.</p>
            </div>
          </CardContent>
        </Card>
      )}
